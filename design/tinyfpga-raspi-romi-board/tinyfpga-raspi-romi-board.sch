...
F 2 "Connector_PinSocket_2.54mm:PinSocket_2x08_P2.54mm_Vertical_SMD" H 10000 3800 50  0001 C CNN
...
F 2 "Connector_PinSocket_2.54mm:PinSocket_2x03_P2.54mm_Vertical_SMD" H 10000 2850 50  0001 C CNN
...
RPI_GPIO24
Text Label 9000 -450 2    50   ~ 0
RPI_GPIO25
Text Label 10250 -1700 2    50   ~ 0
RPI_GPIO26
Text Label 9000 -250 2    50   ~ 0
RPI_GPIO27
Wire Wire Line
	9000 -650 8500 -650
Wire Wire Line
...
U 1 1 5CDDF928
P 3200 4100
F 0 "J9" H 3400 4550 50  0000 R CNN
F 1 "ROMI_MOTOR_DRIVE" H 3850 4450 50  0000 R CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x06_P2.54mm_Vertical_SMD_Pin1Left" H 3200 4100 50  0001 C CNN
...
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x02_P2.54mm_Vertical" H 1150 2200 50  0001 C CNN
...
Wire Wire Line
	1350 2200 1400 2200
Text Label 9550 -550 0    50   ~ 0
ROMI_3V3
$Comp
L Connector_Generic:Conn_02x05_Odd_Even J20
U 1 1 5D017A69
P 10200 -750
F 0 "J20" H 10250 -333 50  0000 C CNN
F 1 "ROMI_POWER" H 10250 -424 50  0000 C CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_2x05_P2.54mm_Vertical_SMD" H 10200 -750 50  0001 C CNN
...
U 1 1 5D1FCECA
P 10550 -450
F 0 "#PWR0103" H 10550 -700 50  0001 C CNN
F 1 "GND" H 10555 -623 50  0000 C CNN
F 2 "" H 10550 -450 50  0001 C CNN
...
U 1 1 5D0E8841
P 8300 -1150
F 0 "J18" H 8408 -169 50  0000 C CNN
F 1 "RPI_EXTRA" H 8408 -260 50  0000 C CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x18_P2.54mm_Vertical" H 8300 -1150 50  0001 C CNN
F 3 "~" H 8300 -1150 50  0001 C CNN
	1    8300 -1150
	1    0    0    -1  
$EndComp
Text Label 9000 -350 2    50   ~ 0
RPI_GPIO26
Text Label 9000 -550 2    50   ~ 0
RPI_GPIO24
Wire Wire Line
	8500 -350 9000 -350
Wire Wire Line
